...
* This sector is loaded into memory at D700h in a standard	*
* configuration. It is responsible for reading most of track 0	*
* into memory on cold boots.					*
*								*
*****************************************************************

origin	equ	0D000H		; Location of the DJ2D PROM on the Sorcerer (normall E000H on non-Sorcerer)
...
*
* Note: the code below will actually be compiled relative to 'origin+700h' or D700H.
* That has been verified, of course, against the original binary image.
* The DJ2D controller card's RAM starts at D400H.
*
org	origin		;Disk Jockey firmware PROM on the Sorcerer
...
*
* RCL9 - refer to my extended explanation in _CBIOS2.mac about these offsets
*
...
fread	push	b
    ...
    * RCL9 - we need to align each chunk of code on 128 byte sector boundaries within
    *        the final binary file to match that of the DJ2D CP/M 24k distribution image.
	ds	80h-($ mod 80h)
stac	equ	$
